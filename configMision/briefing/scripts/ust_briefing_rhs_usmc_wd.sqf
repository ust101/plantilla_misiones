//=======================================================================================================//
// Archivo: ust_briefing_rhs_usmc_wd.sqf                                                                 //
// Autor: CC_Magnetar                                                                                    //
// Adaptado por: [UST] Artur																			 //
// Versión: 0.1                                                                                          //
// Creación del Documento: 13/09/2015                                                                    //
// Descripción: Este documento sirve para ofrecer información de misión si la unidad forma parte de la   //
//             facción RHS: United States  Marine Corps "rhs_faction_usmc_wd".                         	 //
//             http://class.rhsmods.org/rhsusaf/CfgFactionClasses_rhs_faction_usmc_wd.html               // 
//=======================================================================================================//
